...
@section('surface-content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('municipality-land-usage.destroy', $id) }}" method="post" class="form-horizontal">
                @csrf
                {{ method_field('DELETE') }}
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <a href="{{ route('municipality-surface.index') }}" class="btn btn-md btn-danger">होइन</a>
                    </div>
                </div>
            </form>
        </div>
